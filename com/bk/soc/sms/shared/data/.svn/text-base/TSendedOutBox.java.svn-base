...
@DataTransferObject 
@Entity  
@Table(name="SMS.SMS_SendedOutBox")
public class TSendedOutBox
{
	...
	public Long getMsgReference()
	{
		return msgReference;
	}

	public void setMsgReference(Long msgReference)
	{
